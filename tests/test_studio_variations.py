...
def test_coerce_typographic_fields_validated():
    raw = {"angle": "name-literal", "mode": "typographic", "word": "hungry",
           "transform": "letter-inhabit", "target_index": 1, "metaphor": "spoon",
...
def test_coerce_typographic_bad_values_recover():
    raw = {"angle": "name-literal", "mode": "typographic", "word": "Sun",
           "transform": "wat", "target_index": 99, "metaphor": "nope"}
