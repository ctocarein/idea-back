...
| IDX-OPS-01 | Tests de recette | 5 | ✅ | tout | **cahier de recette** ([CAHIER_RECETTE.md](CAHIER_RECETTE.md)) : scénarios bout en bout + critères + traçabilité vers les 153 tests · recette manuelle (LLM/PDF/MinIO réels) §9 |
